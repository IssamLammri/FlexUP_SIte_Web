...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'idCategory', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'nameCategory', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'level', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'idCategoryParent'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLevel(int $level): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function getIdCategoryParent(): ?\App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCategoryParent', []);

        return parent::getIdCategoryParent();
    }

    /**
     * {@inheritDoc}
     */
    public function setIdCategoryParent(?\App\Entity\Category $idCategoryParent): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdCategoryParent', [$idCategoryParent]);

        return parent::setIdCategoryParent($idCategoryParent);
    }
