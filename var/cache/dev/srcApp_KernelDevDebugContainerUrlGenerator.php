...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'participants_groups_index' => [[], ['_controller' => 'App\\Controller\\ParticipantsGroupsController::index'], [], [['text', '/participantsgroups/']], [], []],
        'participants_groups_new' => [[], ['_controller' => 'App\\Controller\\ParticipantsGroupsController::new'], [], [['text', '/participantsgroups/new']], [], []],
        'participants_groups_show' => [['idParticipantG'], ['_controller' => 'App\\Controller\\ParticipantsGroupsController::show'], [], [['variable', '/', '[^/]++', 'idParticipantG', true], ['text', '/participantsgroups']], [], []],
        'participants_groups_edit' => [['idParticipantG'], ['_controller' => 'App\\Controller\\ParticipantsGroupsController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'idParticipantG', true], ['text', '/participantsgroups']], [], []],
        'participants_groups_delete' => [['idParticipantG'], ['_controller' => 'App\\Controller\\ParticipantsGroupsController::delete'], [], [['variable', '/', '[^/]++', 'idParticipantG', true], ['text', '/participantsgroups']], [], []],
        ...
        'ViewServices_index' => [[], ['_controller' => 'App\\Controller\\Services\\ViewServicesController::index'], [], [['text', '/ViewServices/']], [], []],
        'addresses_new' => [[], ['_controller' => 'App\\Controller\\Services\\ViewServicesController::new'], [], [['text', '/ViewServices/new']], [], []],
        'addresses_show' => [['idAddress'], ['_controller' => 'App\\Controller\\Services\\ViewServicesController::show'], [], [['variable', '/', '[^/]++', 'idAddress', true], ['text', '/ViewServices']], [], []],
        'addresses_edit' => [['idAddress'], ['_controller' => 'App\\Controller\\Services\\ViewServicesController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'idAddress', true], ['text', '/ViewServices']], [], []],
        'addresses_delete' => [['idAddress'], ['_controller' => 'App\\Controller\\Services\\ViewServicesController::delete'], [], [['variable', '/', '[^/]++', 'idAddress', true], ['text', '/ViewServices']], [], []],
