...
class CurrencyController extends AbstractController
{
    ...
    /**
     * @Route("/{idCurrency}", name="currency_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idCurrency}/edit", name="currency_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, Currency $currency): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('currency_index', [
                'idCurrency' => $currency->getIdCurrency(),
            ]);
        }
    ...
    /**
     * @Route("/{idCurrency}", name="currency_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Currency $currency): Response
    {
        if ($this->isCsrfTokenValid('delete'.$currency->getIdCurrency(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
